...
/**
 * The pre-Expressive palette, named by appearance rather than by job. Held at
 * the Violet Dusk values so screens not yet moved onto the tonal roles keep
 * compiling and stay roughly in tone. Being a plain object it cannot follow the
 * user's palette choice, which is exactly why it is temporary: every call site
 * should read `PureTvTheme.colors` instead, and this goes away once none do.
 */
@Deprecated("Use PureTvTheme.colors, which follows the selected palette.")
object PureTvColors {
    val Background = Color(0xFF0F0D13)
    val Surface = Color(0xFF141218)
    val SurfaceVariant = Color(0xFF211F26)
    val Surface1 = Color(0xFF1D1B20)
    val Surface2 = Color(0xFF211F26)
    val Surface3 = Color(0xFF2B2930)
    val Hairline = Color(0xFF49454F)
...
/** Fixed shape scale for call sites that predate the intensity-aware scale. */
